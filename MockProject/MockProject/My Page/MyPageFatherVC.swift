...
class MyPageFatherVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        accountButton.backgroundColor = #colorLiteral(red: 0.5838350723, green: 0.9869053812, blue: 1, alpha: 0.5509417808)
...
extension MyPageFatherVC: ColorForButtonDelegate {
    func chooseColor(_ index: Int) {
        ...
        let backgroundColor0: UIColor = (index == 0) ? #colorLiteral(red: 0.5838350723, green: 0.9869053812, blue: 1, alpha: 0.5509417808) : .white
        ...
        let backgroundColor1: UIColor = (index == 1) ? #colorLiteral(red: 0.5838350723, green: 0.9869053812, blue: 1, alpha: 0.5509417808) : .white
        ...
        let backgroundColor2: UIColor = (index == 2) ? #colorLiteral(red: 0.5838350723, green: 0.9869053812, blue: 1, alpha: 0.5509417808) : .white
        ...
        let backgroundColor3: UIColor = (index == 3) ? #colorLiteral(red: 0.5838350723, green: 0.9869053812, blue: 1, alpha: 0.5509417808) : .white
